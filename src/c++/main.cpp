...
int main(int argc, char *argv[]) {
    ...
    if (result) {
        ...
        cout << "packet IP version (class): " << ip -> ip_vhl << endl;

        cout << "packet Protocol: " << ip -> ip_p << endl;

        in_addr_t source_address = ip -> ip_src.s_addr;
        char source_string[16];
        cout << "packet IP source address: " << inet_ntop(AF_INET, &source_address, source_string, sizeof(source_string)) << endl;

        in_addr_t destination_address = ip -> ip_dst.s_addr;
        ...
        cout << "Total length: " << &(ip -> ip_len) << endl;
        ...
        u_short tcp_source_port = tcp -> th_sport;
        u_short tcp_destination_port = tcp -> th_dport;

        cout << "TCP source port: " << tcp_source_port << endl;
        cout << "TCP destination port: " << tcp_destination_port << endl;
        cout << "TCP payload: " << sizeof(payload) << endl;
    }
